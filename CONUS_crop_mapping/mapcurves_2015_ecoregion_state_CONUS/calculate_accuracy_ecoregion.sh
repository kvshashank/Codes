## This code calculates ecoregion-wise users and producers accuracy for the year 2015. 
## Prior to running this code, run the code create_rstats_cdl_ecoregion.sh
## The data for this code /home/vk5/mapcurves_2015_ecoregion_state_CONUS/mapcurves_2015_ecoregion on theseus 
...
r.stats -cn input=2015_pheno_reclassed_ecolevel_mapcurves,2015_30m_cdl_no_veg output=r.stats_phenoregion_cdl_2015

# Calculate accuracies for 
crops=( 1 3 4 5 24 36 37 61 )
n_crops=${#crops[@]}

rm accuracy_2015_ecoregion_level
touch accuracy_2015_ecoregion_level
...
echo ${list[@]} >> accuracy_2015_ecoregion_level
done
